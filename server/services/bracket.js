...
export const BRACKET_ADVANCEMENT = {
  ...
  M2: { winner: { matchId: "O2", slot: "away" } },
  M9: { winner: { matchId: "O3", slot: "home" } },
  M10: { winner: { matchId: "O3", slot: "away" } },
  ...
  O5: { winner: { matchId: "Q2", slot: "home" } },
  O6: { winner: { matchId: "Q2", slot: "away" } },
  O3: { winner: { matchId: "Q3", slot: "home" } },
  O4: { winner: { matchId: "Q3", slot: "away" } },
  O8: { winner: { matchId: "Q4", slot: "home" } },
  O7: { winner: { matchId: "Q4", slot: "away" } },
